...
const base ={
  ...
  covInfo:'/tianxing/ncov/index?key=b5919dd6f573907e378d0a6be7a78ff3',//疫情病毒信息
  chinaData:'/qq/newsqa/v1/query/inner/publish/modules/list?modules=diseaseh5Shelf',//国内疫情数据
  ...
  worldData:'/qq/newsqa/v1/automation/modules/list?modules=WomWorld,WomAboard',//国外疫情数据
  ...
  Vaccine:'/qq/newsqa/v1/automation/modules/list?modules=VaccineTopData'//疫苗接种信息
}
